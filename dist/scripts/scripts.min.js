...
var sections = ['#Top', '#Objective', '#Projects', '#Skills', '#Employment', '#More'];
...
var layoutIsMediumOrLarger = function layoutIsMediumOrLarger() {
	return $md_min.matches === true;
};
var topHeightCompensation = 58;
...
var scrollToTarget = function scrollToTarget($target, highlight) {
...
$(function () {
	...
	var footerJumpLinks = document.querySelectorAll('footer [class*=jump]');
	var skillWidget = {
		...
		toggleMenu: function toggleMenu(breakpoint) {
		...
		updateList: function updateList($input) {
			var value = $input.val();
			if ($input.is(':checked')) checkedSkills.push(value);else checkedSkills.splice(checkedSkills.indexOf(value), 1);
	...
	$sm_min.onchange = function () {
		return skillWidget.toggleMenu($sm_min);
	};
	$md_min.onchange = function () {
		return document.querySelector('body').classList.remove('overlay-visible');
	};
	...
	footerJumpLinks.forEach(function (link) {
		link.addEventListener('click', function (e) {
